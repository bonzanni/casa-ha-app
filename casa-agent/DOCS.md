...
| `telegram_rich_text` | Render Markdown (bold, italic, inline code, and monospace code blocks) in agent replies, including engagement narration and question prompts. Default: `true`. Set to `false` to send everything as plain text. |
